...
with open('./realtoxicityprompts-data/generations/prompted/prompted_gens_gpt2_medium.jsonl','r') as json_file:
    json_list = list(json_file)

generations = open('./gpt2_generation.txt','w')
toxicity = open('./gpt2_toxicity.txt','w')
toxicity01 = open('./gpt2_toxicity01.txt','w')
